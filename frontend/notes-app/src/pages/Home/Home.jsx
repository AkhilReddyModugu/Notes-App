...
const Home = () => {
  ...
  const getUserInfo = async () => {
    try {
      const response = await axiosInstance.get("/get-user"); // Added await
    ...
    <>
      ...
      <div className="container mx-auto">
        {allNotes.length>0 ? (<div className='grid grid-cols-3 gap-4 mt-8'>
          ...
          <EmptyCard imgSrc={isSearch? NoDataImg: AddNotesImg} message={isSearch?`Oops! No notes found matching your search.`:`Start creating your first note! Click the 'Add' button to note down
